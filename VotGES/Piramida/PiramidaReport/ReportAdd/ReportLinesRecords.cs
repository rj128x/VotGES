	...
	class ReportLinesRecords
	{
		...
		public static void CreateLinesP() {
			P_VL110_Otd = new RecordTypeCalc("P_VL110_Otd", "ВЛ 110кВ отдача P", new RecordCalcDelegate((report, date) => {
				return
					report.Data[date][PiramidaRecords.P_VL110_Berezovka_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Dubovaya_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Ivanovka_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Kauchuk_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL110_KSHT1_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL110_KSHT2_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Svetlaya_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL110_TEC_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Vodozabor1_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Vodozabor2_Otd.Key];
			}));

			P_VL110_Priem = new RecordTypeCalc("P_VL110_Priem", "ВЛ 110кВ прием P", new RecordCalcDelegate((report, date) => {
				return
					report.Data[date][PiramidaRecords.P_VL110_Berezovka_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Dubovaya_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Ivanovka_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Kauchuk_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL110_KSHT1_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL110_KSHT2_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Svetlaya_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL110_TEC_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Vodozabor1_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL110_Vodozabor2_Priem.Key];
			}));

			P_VL220_Otd = new RecordTypeCalc("P_VL220_Otd", "ВЛ 220кВ отдача P", new RecordCalcDelegate((report, date) => {
				return
					report.Data[date][PiramidaRecords.P_VL220_Izhevsk1_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL220_Izhevsk2_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL220_Kauchuk1_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL220_Kauchuk2_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL220_Svetlaya_Otd.Key];
			}));

			P_VL220_Priem = new RecordTypeCalc("P_VL220_Priem", "ВЛ 220кВ прием P", new RecordCalcDelegate((report, date) => {
				return
					report.Data[date][PiramidaRecords.P_VL220_Izhevsk1_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL220_Izhevsk2_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL220_Kauchuk1_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL220_Kauchuk2_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL220_Svetlaya_Priem.Key];
			}));

			P_VL500_Otd= new RecordTypeCalc("P_VL500_Otd", "ВЛ 500кВ отдача P", new RecordCalcDelegate((report, date) => {
				return
					report.Data[date][PiramidaRecords.P_VL500_Emelino_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL500_Karmanovo_Otd.Key] +
					report.Data[date][PiramidaRecords.P_VL500_Vyatka_Otd.Key];
			}));

			P_VL500_Priem = new RecordTypeCalc("P_VL500_Priem", "ВЛ 500кВ прием P", new RecordCalcDelegate((report, date) => {
				return
					report.Data[date][PiramidaRecords.P_VL500_Emelino_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL500_Karmanovo_Priem.Key] +
					report.Data[date][PiramidaRecords.P_VL500_Vytka_Priem.Key];
			}));

			P_VL110_Saldo = new RecordTypeCalc("P_VL110_Saldo", "ВЛ 110 кВ сальдо P", new RecordCalcDelegate((report, date) => {
				return
					report.Data[date][ReportLinesRecords.P_VL110_Otd.ID] - report.Data[date][ReportLinesRecords.P_VL110_Priem.ID];
			}));

			P_VL220_Saldo = new RecordTypeCalc("P_VL220_Saldo", "ВЛ 220 кВ сальдо P", new RecordCalcDelegate((report, date) => {
				return
					report.Data[date][ReportLinesRecords.P_VL220_Otd.ID] - report.Data[date][ReportLinesRecords.P_VL220_Priem.ID];
			}));

			P_VL500_Saldo = new RecordTypeCalc("P_VL500_Saldo", "ВЛ 500 кВ сальдо P", new RecordCalcDelegate((report, date) => {
				return
					report.Data[date][ReportLinesRecords.P_VL500_Otd.ID] - report.Data[date][ReportLinesRecords.P_VL500_Priem.ID];
			}));
		}
