...
namespace VotGES.PrognozNB
{
	public class CheckPrognozNB
	{
		...
		private SortedList<DateTime,double> pbr;
		public SortedList<DateTime, double> PBR {
			get { return pbr; }
			set { pbr = value; }
		}

		private SortedList<DateTime,double> nbFakt;
		public SortedList<DateTime, double> NBFakt {
			get { return nbFakt; }
			set { nbFakt = value; }
		}

		private SortedList<DateTime,double> naporFakt;
		public SortedList<DateTime, double> NaporFakt {
			get { return naporFakt; }
			set { naporFakt = value; }
		}

		private SortedList<DateTime,double> vbFakt;
		public SortedList<DateTime, double> VBFakt {
			get { return vbFakt; }
			set { vbFakt = value; }
		}

		private SortedList<DateTime,double> qFakt;
		public SortedList<DateTime, double> QFakt {
			get { return qFakt; }
			set { qFakt = value; }
		}

		private SortedList<DateTime,double> pFakt;
		...
		public CheckPrognozNB(DateTime dateStart, int daysCount) {
		...
		public SortedList<DateTime,PrognozNBFirstData> readFirstData(DateTime date) {
		...
		public void writeFaktData(ChartData data) {
